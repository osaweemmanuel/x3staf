...
export const ForgotPassword = () => {
  ...
  const handleEmailSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = (await sendOTP({ email })) as {
        data: any;
      ...
      {emailSubmitted ? (
        otpSubmitted ? (
          passwordSubmitted ? (
            ...
            >
              <div className=" mb-2 w-full flex bg-white px-3 py-2 rounded-3xl">
                <input
              ...
              <div className=" mb-2 w-full flex bg-white px-3 py-2 rounded-3xl">
                <input
                  ...
                  required
                />
                <div onClick={HandleConfirmPasswordVisibility}>
                  <FontAwesomeIcon
          ...
          <>
            ...
            <div className="text-sm text-gray-800 pt-1">
              {timer > 0 ? (
                <p>
                  Resend OTP in <b>{timer}</b> seconds
                </p>
              ) : (
